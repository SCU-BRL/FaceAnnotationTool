...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, filename=None):
        ...
        open = action('&Open', self.openFile,
                'Ctrl+f', 'open', u'Open image or label file')
        ...
        openAnnotation = action('&Open Annotation', self.openAnnotation,
                'Ctrl+o', 'openAnnotation', u'Open Annotation')
    ...
    def openAnnotation(self, _value=False):
        ...
        # according to image file name, get xml annotation file.
        txtFilename = self.filename.split('.')[0] + '.xml'
        if os.path.exists(txtFilename) is False:
            return
...
#
    ...
    # Load pre-defined object class, can multi classes
